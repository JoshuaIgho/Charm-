...
const Footer = () => {
  ...
  const socialLinks = [
    { icon: Facebook, href: 'https://facebook.com/tajewelry', label: 'Facebook' },
    { icon: Instagram, href: 'https://instagram.com/tajewelry', label: 'Instagram' },
    { icon: Twitter, href: 'https://twitter.com/tajewelry', label: 'Twitter' },
    { icon: Youtube, href: 'https://youtube.com/tajewelry', label: 'YouTube' },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 mb-6 leading-relaxed">
              Discover meaningful everyday jewelry crafted for the modern T-girl. 
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm">3 Ayoola Street, Oworirosbo, Oworonshoki, Lagos, Nigeria</span>
              </div>
              <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm">info@ta-jewelry.com</span>
              </div>
            </div>
            ...
            <div className="mb-8">
              ...
              <form onSubmit={handleNewsletterSubmit} className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:border-primary-600 focus:ring-1 focus:ring-primary-600 focus:outline-none"
                  required
                />
                <button
                  type="submit"
        ...
        <div className="container-custom py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="text-gray-400 text-sm">
              © {new Date().getFullYear()} TA Jewelry. All rights reserved.
            </div>
