'use strict';
/* build-hook-start *//*00001*/try { require('/Users/user/.vscode/extensions/wallabyjs.console-ninja-1.0.470/out/buildHook/index.js').default({tool: 'jest', checkSum: '20f0ba4e42e160b0562132VAlMVhpVDlcABlUDUgECVVFQBFED', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/user/.vscode/extensions/wallabyjs.console-ninja-1.0.470/out/buildHook/index.js').then(m => m.default.default({tool: 'jest', checkSum: '20f0ba4e42e160b0562132VAlMVhpVDlcABlUDUgECVVFQBFED', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
