'use strict';
/* build-hook-start *//*00001*/try { require('/Users/user/.vscode/extensions/wallabyjs.console-ninja-1.0.470/out/buildHook/index.js').default({tool: 'jest', checkSum: '206d813a1fe6cf1e2db2ccBF0WBh1RCwRSB1BfBwZWB1UBBVoH', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/user/.vscode/extensions/wallabyjs.console-ninja-1.0.470/out/buildHook/index.js').then(m => m.default.default({tool: 'jest', checkSum: '206d813a1fe6cf1e2db2ccBF0WBh1RCwRSB1BfBwZWB1UBBVoH', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
